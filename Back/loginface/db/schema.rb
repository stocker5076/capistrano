...
ActiveRecord::Schema.define(version: 20160908020115) do
  ...
  create_table "perros", force: :cascade do |t|
    ...
    t.string   "provider"
    t.string   "name"
    t.index ["email"], name: "index_perros_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_perros_on_reset_password_token", unique: true, using: :btree
  end
